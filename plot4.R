###########################################################
## Purpose: Create plot4 of the Household Power Consumption data
...
plot(power_consum$Time
     , na.omit(power_consum$Global_active_power)
     , type = "l"
...
## Plot 4
plot(power_consum$Time
     , na.omit(power_consum$Global_reactive_power)
     , type = "l"
